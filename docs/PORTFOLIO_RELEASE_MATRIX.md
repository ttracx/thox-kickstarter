...
Last refreshed: **2026-07-02 EOD** (T-41 days to Kickstarter launch Sep 8 2026 / T-35 days to filming window Jul 28 2026). Phase C 12B fully shipped end-to-end this refresh.
...
## 1. Shipping SKUs (Sep 8 launch)

| SKU | Base model (Ollama tag) | Device SoC | Device firmware | Factory registry | Latest release | Sep 8 launch status |
|---|---|---|---|---|---|---|
...
| Product | Base model | Runtime path | Host | Factory registry | Latest release | Sep 8 launch status |
|---|---|---|---|---|---|---|
