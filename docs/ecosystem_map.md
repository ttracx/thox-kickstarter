...
that together run the Sep 1 2026 launch and the months that follow. This
...
- **When to use**: post-launch (Sep 1+) for backer-report ingestion, fulfillment tracking, referral analytics
