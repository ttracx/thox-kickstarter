...
- **Launch day (Sep 8 2026)**: smoke-tested and deployed BEFORE the click-launch moment so the first backer-report import can run within minutes of the first pledges
- **Live campaign (Sep 8 to Oct 8)**: ingestion + fulfillment-risk + update-drafter run on operator demand; no public-facing endpoints
...
on Sep 8 2026. Owner is Tommy unless noted.
