...
Eight LinkedIn posts spread across the six-week run-up to Sep 8, 2026. Posts alternate between Tommy Xaypanya (4 posts) and Craig Ross (4 posts), with a joint launch-day post co-signed.
...
>
> We launch on Kickstarter on September 8. Between now and then I will post the engineering deep-dives, the device walkthrough, the manufacturing story, and the unboxing thinking. If that is interesting, follow along.
...
>
> The campaign launches Sep 8 at 09:00 PT. Early-bird tiers are first-come during the first 24 hours.
...
CTA: Save Sep 8 09:00 PT at https://thox.ai/launch
...
## Post 8: Tommy and Craig joint, T-0 (Mon Sep 8, 2026, 09:01 PT)
