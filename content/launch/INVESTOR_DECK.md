...
The Sep 8 launch covers four SKUs. The stretch ladder unveils three concept devices (ThoxArm, ThoxVault, ThoxCargo). The full ecosystem covers wake-word, desktop edge, multi-node cluster, workstation, articulated mount, secure identity, and field carrier.
...
**Key takeaway:** Four shipping SKUs from $39 to $499 launch Sep 8; three concept devices are roadmap unveils, not promised products.
...
- Sep 8 launch on Kickstarter. Goal $250K. Ceiling $3M. 30-day window.
...
Timing: closes alongside or shortly after the Kickstarter campaign window (Sep 8 to October 8, 2026).
