...
Launch press kit for the THOX.ai Kickstarter, September 8, 2026. Companion to `docs/PRESS_KIT.md` (which is the operations-facing version with embargo policy, asset list, and outlet contacts).
...
The September 8, 2026 Kickstarter launches four devices:
