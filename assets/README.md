...
| `assets/device/` | `devices/concepts/thoxarm/renders/iso_hero.png` | ThoxArm concept (stretch goal $1.5M) |
| `assets/device/` | `devices/concepts/thoxvault/renders/iso_hero.png` | ThoxVault concept (stretch goal $2.5M) |
| `assets/device/` | `devices/concepts/thoxcargo/renders/iso_hero.png` | ThoxCargo concept (stretch goal $3M) |
