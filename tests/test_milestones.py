...
Launch is 2026-09-08. Today (per repo state) is 2026-06-25. T-48 corresponds
...
def test_milestones_launch_date_referenced():
    text = MILESTONES.read_text(encoding="utf-8")
    assert "2026-09-08" in text, "launch date 2026-09-08 must be in MILESTONES.md"
